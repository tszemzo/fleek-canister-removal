...
export type ResultError = { Err?: string };
export type ResultCall = { Ok: { return: Array<number> } } & ResultError;
export type ResultCreate = { Ok: { canister_id: Principal } } & ResultError;
export type ResultSend = { Ok: null } | ResultError;
export type Role =
  | { Custodian: null }
  | { Contact: null }
  | { Controller: null };
